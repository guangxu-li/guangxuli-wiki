...
- Related Patterns
    - Abstract factory interfaces are often implemented with [factory methods]([[Design Patterns/Creational/Factory Method]]), but they can also be implemented using ()[[Design Patterns/Catalog/Creational/Prototype]]